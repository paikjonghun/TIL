...
- [목차](#목차)
- [1. 실습](#1-실습)
	- [1. 1. 1에서 100까지의 소수를 구하시오.](#1-1-1에서-100까지의-소수를-구하시오)
	- [1. 2. 구구단 2~9단 출력](#1-2-구구단-29단-출력)
	- [1. 3. 1에서 100까지의 숫자 중 소수 골라내기.](#1-3-1에서-100까지의-숫자-중-소수-골라내기)
	- [1. 4. 다중 반복문 활용해서 별 찍기](#1-4-다중-반복문-활용해서-별-찍기)
