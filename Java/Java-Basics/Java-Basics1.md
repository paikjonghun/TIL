## 목차
- [목차](#목차)
- [1. 이클립스(4.19버전) 설치](#1-이클립스419버전-설치)
- [2. JDK(11버전) 설치](#2-jdk11버전-설치)
- [3. Eclipse 설정](#3-eclipse-설정)
- [4. Java](#4-java)
- [5. 변수](#5-변수)
  - [5. 1. 변수 기본 타입](#5-1-변수-기본-타입)
  - [5. 2. 변수 선언 방법](#5-2-변수-선언-방법)
  - [5. 3. 변수 사용 시 주의사항](#5-3-변수-사용-시-주의사항)
- [6. 사칙연산](#6-사칙연산)
- [7. 비교연산](#7-비교연산)
- [8. 주석](#8-주석)
- [9. 증감연산](#9-증감연산)
